$(document).ready(function(){
    ...
    $('.htmlcss').mouseleave(function(){
        $(this).attr('src', 'img/1html_300x300.jpg');
    });
    ...
    $('.jquery').mouseleave(function(){
        $(this).attr('src', 'img/2jqueryajax_300x300.jpg');
    });



    $('.git').mouseenter(function(){
        $(this).attr('src', 'img/3github_300x300.jpg');
    });

    $('.git').mouseleave(function(){
        $(this).attr('src', 'img/3git_300x300.jpg');
    });
    ...
    $('.ruby').mouseleave(function(){
        $(this).attr('src', 'img/4comp-rub_300x300.jpg');
    });
    ...
    $('.responsive').mouseenter(function(){
        $(this).attr('src', 'img/6responsive-design_300x300.jpg');
    });

    $('.responsive').mouseleave(function(){
        $(this).attr('src', 'img/6responsive_300x300.jpg');
    });
    ...
    $('.frameworks').mouseleave(function(){
        $(this).attr('src', 'img/7bootstrap-mater_300x300.jpg');
    });
